...
/* Created on:     30/03/2023 14:29:27                          */
/*==============================================================*/
...
/*==============================================================*/
create or replace table DETIL_PEMBELIAN 
(
   ID_TRX_PEMB          integer                        not null,
   ID_BARANG            integer                        not null,
   QTY_DETIL__PEMB      integer                        null,
   constraint PK_DETIL_PEMBELIAN primary key clustered (ID_TRX_PEMB, ID_BARANG)
);

/*==============================================================*/
/* Table: DETIL_PENJUALAN                                       */
/*==============================================================*/
create or replace table DETIL_PENJUALAN 
(
   ID_TRX_PENJ          integer                        not null,
   ID_BARANG            integer                        not null,
   QTY_DETIL_PENJ       integer                        null,
   constraint PK_DETIL_PENJUALAN primary key clustered (ID_TRX_PENJ, ID_BARANG)
);
...
alter table DETIL_PEMBELIAN
   add constraint FK_DETIL_PE_RELATIONS_TRX_PEMB foreign key (ID_TRX_PEMB)
      references TRX_PEMBELIAN (ID_TRX_PEMB)
      on update restrict
      on delete restrict;

alter table DETIL_PEMBELIAN
   add constraint FK_DETIL_PE_RELATIONS_BARANG foreign key (ID_BARANG)
      references BARANG (ID_BARANG)
      on update restrict
      on delete restrict;

alter table DETIL_PENJUALAN
   add constraint FK_DETIL_PE_RELATIONS_TRX_PENJ foreign key (ID_TRX_PENJ)
